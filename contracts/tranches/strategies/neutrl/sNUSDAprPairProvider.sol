...
contract sNUSDAprPairProvider is IStrategyAprPairProvider {
    ...
    function getAPRtarget() public view returns (int64) {
        ...
        uint256 apr = unvestedAmount * SECONDS_PER_YEAR * 1e18 / (VESTING_PERIOD_sUSDe - deltaT) / totalAssets;
    ...
    function getAPRbase() public view returns (int64) {
        ...
        uint256 apr = unvestedAmount * SECONDS_PER_YEAR * 1e18 / (vestingPeriod - deltaT) / totalAssets;
